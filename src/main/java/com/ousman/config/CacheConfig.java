 ...
 *  ├─────────────┼────────────┼──────────────────────────────────────────────┤
 *  │ products    │ 10 minutes │ @CacheEvict in ProductService / SaleService  │
 *  │             │            │ (write ops)                                  │
 *  └─────────────┴────────────┴──────────────────────────────────────────────┘
 *
 * Load balancing note:
 ...
 *  the other replica's cache expires within its TTL (10 min), which is
...
public class CacheConfig {
    ...
    public CacheManager cacheManager() {
        ...
        manager.setCacheNames(java.util.List.of("products"));
        return manager;
    }
}
